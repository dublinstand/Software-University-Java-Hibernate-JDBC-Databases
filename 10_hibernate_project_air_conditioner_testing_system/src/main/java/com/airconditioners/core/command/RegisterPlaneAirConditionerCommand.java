...
import com.airconditioners.domain.entities.airConditioners.PlaneAirConditioner;
import com.airconditioners.repositories.BasicAirConditionerRepository;

public class RegisterPlaneAirConditionerCommand extends Command {
    ...
    public RegisterPlaneAirConditionerCommand(String[] tokens) {
        super(tokens);
    }
    ...
    public String execute() {
        ...
        int electricityUsed = Integer.parseInt(super.getTokens()[3]);
        ...
        //initialize our basicAirConditioner to be a PlaneAirConditioner with passing the data in the constructor
        BasicAirConditioner basicAirConditioner = new PlaneAirConditioner(manufacturer, model, volumeCoverage, electricityUsed);
        //save it
